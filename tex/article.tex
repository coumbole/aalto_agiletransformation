...
productivity and quality \citegen{Livermore2008}, which makes them attractive
...
\citegen{Petersen2010}.

However, large organizations may have problems introducing agile methods
\citegen{Dyba2009}. As agile methods are initially designed for small teams
their application has proven to be problematic in a larger scale
\citegen{Boehm2005}. In a large organization development teams will need to
...
tailor agile practices to suite a large organization \citegen{Lindvall2004}.

% --> There is demand for a summarizing study of large agile transformations as
% the evidence is currently scattered.
% 
% These models strive for consistent quality and performance
...
\citegen{Livermore2008}. Agile development is not founded on the use of individual
...
in projects \citegen{Boehm2005}, or a change control board may inhibit the use of
...
process must be adjusted according to their needs \citegen{Lindvall2004,
Cohn2003, Boehm2005}.
...
method for systematic literature reviews (SLR) \citegen{Kitchenham2007}. The method
...
% relating to agile transformations in large organizations.
%    --> Removed 
%    --> In our experience a keyword search will not match the large scale
%    facet, but a manual semantic analysis of the article meta data is required.
