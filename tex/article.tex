...
gives proposals for future research.
...
challenges of large scale agile development \citegen{Lindvall2004}. Further,
...
Our results show that a body of research on large scale agile transformations
has emerged. We aim to continue research on this topic by conducting a
systematic literature review. Beyond descriptive reports on agile
transformations we found very little studies with quantitative comparison of
organizations before and after the transformations.
...
\begin{supertabular}{ l p{11.4cm} }
    {[}S1{]} & \bibentry{S1} \\ \shrinkheight{-1.6cm}
    {[}S2{]} & \bibentry{S2} \\ 
    {[}S3{]} & \bibentry{S3} \\ 
    {[}S4{]} & \bibentry{S4} \\ 
    {[}S5{]} & \bibentry{S5} \\ 
    ...
    {[}S7{]} & \bibentry{S7} \\ 
    {[}S8{]} & \bibentry{S8} \\ 
    {[}S9{]} & \bibentry{S9} \\ \shrinkheight{-1.6cm}
    {[}S10{]} & \bibentry{S10} \\ 
    {[}S11{]} & \bibentry{S11} \\ 
    {[}S12{]} & \bibentry{S12} \\ 
    {[}S13{]} & \bibentry{S13} \\ 
