...
% It would also be sociatelly desirable to effectivize large software projects,
% because large projects often have societal influence.

% Agile methods are more difficult to implement in large organizations
% \citep{Dyba2008}.
...
% The full set of requirements of a large system could be too cumbersome for
% individual teams to manage.
% \citet{Boehm2003b} have suggested that sizable organizations should not
% attempt to become fully agile.
...
requirements management. Implementing effective requirements breakdown and
long term requirements planning were seen as challenges. The complementary
success factor was to pay close attention on how the Product Owner role 
was implemented.

Yet another complementary relationship was observed in that implementing the
...
A challenge realting particularly to large scale is that development teams need
...
\citet{Cohn2003} brings up a number of challenges that our research also
discovered.
...
grounds for the claims presented. Our research can be considered to groundedly
confirm the claims presented in existing literature.
...
up.
It should also be noted that the thoroughness of discussion on various topics
...
topic may be used as an estimate of relative importance.
...
\subsection{Possible weakness of evidence due to primary study quality}
...
motivation for the standpoint. Although most of the primary studies are
subjective experience reports, we still think this study can draw accurate and
