...
limited size \citep{Boehm2005}. It has proven that it may be problematic
to introduce agile practices in large organizations \citep{Dyba2009}.
Nevertheless, the benefits of agile are pursued by large organizations.
...
\citet{Boehm2003b} have suggested that sizable organizations should not attempt
...
measuring the success of the transformation. The study has been performed as a
...
Applying agile in large scale has been noted as a current research trend. 
\citep{Freudenberg2010} conducted a survey at the 2010 XP conference,
