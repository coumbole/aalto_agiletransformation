...
The most extreme case of adoption was a big bang transformation. To realize
...
of involvement of management and development teams. In some cases teams played a
passive role, and in some cases management was described to be reluctant to
change. In many cases both management and development dealt with the
...
organizations were striving to introduce a culture of continuous improvement, which
...
TODO:
* Mikä erityisyys on inhouse coachingissa?
* Organizaation sijotus sisäisiin coach-positionihin?
...
TODO:
* Continuous builds and testing --> setting up the environment?
* Hassusti otsikoitu?
...
TODO:
* Muuta ylemmäksi järjestyksessä
* Mieti rakenne
* Mieti onko ``other than development'' hyvä otsikko
