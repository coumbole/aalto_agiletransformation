...
\begin{table}
    \begin{tabular}{ p{1.5cm} l l }
        \toprule
        Reason    &  Examples  &  Sources   \\
        \midrule
        
        \multicolumn{3}{l}{Demand of improved delivery speed or frequency}  \\
         &  Time To Market must lessen           & x \\
         &  Demand for frequent deliveries       & x \\
         &  Too long cycle time before feedback  & x \\
        
        \multicolumn{3}{l}{General problems with management of software development} \\
         &  General management dysfunction                & x \\
         &  Problems with motivation and morale           & x \\
         &  Problems coordinating a growing organization  & x \\
        
        \multicolumn{3}{l}{Demand for flexibility or responsiveness}  \\
         &  Responsiveness to business needs  & x \\
         &  Adaptation as projects evolve     & x \\
        
        \multicolumn{3}{l}{Problems with overhead and excess in process}  \\
         &  Excess, slowness and costs caused by process  & x \\
         &  The current process is being ignored          & x \\
        
        \multicolumn{3}{l}{Demand to improve product quality}  \\
        
        \multicolumn{3}{l}{Problems with planning or keeping schedules}  \\
        
        \multicolumn{3}{l}{Demand of better customer collaboration}  \\
         &  Customers push for improvement  & x \\
                
        \multicolumn{3}{l}{Lack of focus or priorities}  \\
         &  Business needs or priorities are not regarded  & x \\
         &  Requirements are not understood                & x \\
        
        \multicolumn{3}{l}{Communication and collaboration dificulties}  \\
         &  Problems in communication across and within projects  & x \\
         &  Teams work in silos or isolation  & x \\
...
deliver software more frequently. Companies saw it critical to reduce the Time
To Market (TTM) of new features.
