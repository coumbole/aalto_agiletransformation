...
unique organizations were identified in the primary studies. We use the word
\emph{case} to refer to the individual case organizations, and the word
\emph{study} to refer to the primary studies.
...
questions. The methods used for extracting the results were described in
...
Scrum, which was the sole agile method mentioned in 28 studies. The second most
...
\begin{table}[t]
    \begin{tabular}{ l r }
        ...
        \bottomrule
    \end{tabular}
    \caption{Agile methods reported in the transformed organization}
...
\ref{table:reasonstochange}. The reasons to change were mainly demands for
improvement or identified problems in the current process.
...
deliver software more frequently. A frequent theme was the desire to reduce Time To Market (TTM).
...
[P2] They THINK that agile will make them deliver faster
