...
* When: The community stayed
* What: There were e-mail lists
* What: Discssion forums were used for direct conversation instead of using the change leader
* Particular: It is claimed that communities are often used
* Benefit: Reinforcing agile practices

[P6]
* Who: People
* What: Mailing list for sharing information on agile
* What: Pockets of committed communities
* Purpose: Leveraging promoting force of people in the trenches

[P7]
* Who: Scrum masters
* When: Beginning
* What: Peer groups for Scrum masters
* Benefit: The peer groups evolved into a Scrum master community
* Benefit: The community was essential in growing managers to agile roles

[P9]
* When: In the transformation
* What: People attended to external communities, there were internal champions
* Benefit: The movement created interest in agile

[P10]
* Who: tems
* What: Teams started communicating through e-mail groups
* What: Use of wikis, informal gatherings
* Particular: The interest was voluntary, the company started creating official programme

[P11]
* Who: Scrum masters, people managers
* What: Scrum masters met regularly --> Helped coordinate work
* Particular: Product owners should also have formed their own community

[P12]
* Who: Everyone
* Why: The organization introduced a matrix structure
* What: People met peers from other parts of the company, there were discipline specific meetings
* Benefit: People started talking with each other
* Particular: The agile culture was initiated

[P14]
* What: Agile support group
* What: Attempted to support viral spreading of agile

[P32]
* What: A coaching community
* Particular: The community took time to build, as coaching is a skill not learned easily

[P41]
* When: The transition team moved aside
* Who: Scrum master, teams
* What: Special interest groups were formed to reinforce the new practices
* Purpose: Create learning organization

[P42]
* Why: Needed for creating a learning organization and evolve the organization
* What: Communities of practice
* What: Bring in as many ideas as possible
* Purpose: Create learning organization

[P45]
* What: All data from teams was gathered
* Purpose: Set up a network of information for Scrum masters and product owners
* Purpose: Create a round table of experts

[P47]
* When: Broader adoption of agile
* Why: Coaches saw a need to create an environment to support learning and influence agile
* What: Coach community, supported by a particular experienced team
* Particular: voluntarily participation
* Particular: It was created by passionate individuals rather than management decision
* What: The community organizes agile events

[P52]
* When: There was many scrum masters
* What: Community of Scrum masters
* Why: The team of Scrum masters became so big that it was hard to coordinate formally.
       They started changing experiences less formally, in order to become better in the task.
* Benefit: When people started contributing from the wider scope a positive feedback loop was created
* Benefit: People developed a learning habit, continuous improvement in the organization
