...
challenges. As stated by Research Question 3, we investigated what challenges
large organizations introducing agile methods may face.
...
\begin{figure}[!b]
  \begin{center}
    ...
    \caption{Challenges in agile transformation}
...
about new roles and responsibilities that the agile model might bring [P44]. For
