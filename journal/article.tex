...
transformation. At the time it was realized that the organization should change
the way of working a consultant was typically hired to give an introduction to
agile.

It was described that external consultants were invited every now and then to
bring in fresh ideas to the organization [P6].

External consultants were especially used in the beginning to ignite interest in
agile methods [P9].

External consultants assessed the current state of the organization, and
recommended what kind of model to apply [P51].

It was recommended to bring in extenal help as early as possible, before truoble
starts rising in the transformation [P16].

People were also more comfortable when the advice was given by impartial persons
external to the organization [P16, P29].

A particular wish in using consultants was that they would speed up the adoption
[P34]. Consultants were already experts in the agile methods and could quickly
tell solutions to problems.
...
[P5]
* Who: Dean Leffingwell
* What: Advise, and tell to do what's next

[P6]
* When: Pilot teams
* Who: Ken Schwaber, etc.
* What: Early coaching
--
* What: Coach Scrum masters
* When: Continue inviting agile experts
* What: Bring fresh ideas
--
* Why: It can save money and trouble if internal skills are scarce
* How: Apply them wisely

[P7]
* When: In the introduction
* Who: Craig Larman
* What: Introduce, train certified Scrum masters

[P8]
* When: Earlier
* What: External consulting had been contracted
--
* When: In the transformation
* What: Used a wide range of external consultants

[P9]
* When: In the beginning
* Who: Ken Schwaber, Jeff Sutherland
* What: To ignite interest
--
* When: In the adaption
* Who: Experienced agile coaches
* What: To train Scrum on a regular basis

[P16]
* When: In the beginning
* Who: Industry experts
* What: The cross functional team reached out to consultants
--
* When: In the transformation
* Who: Professional trainers
* What: 25\% of R\&D sent to professional training 
* Who: Experienced consultants
* What: assist teams POs and ScMs
* Benefit: A key success factor
* Benefit: Their experience helped drive the transformation
* Benefit: People were more comfortable receiving advice from outsiders

[P17]
* Who: Rally software
* What: Provide software and services to accelerate adoption
* Benefit: Top notch consulting is critical for success

[P18]
* When: For the pilot team
* Who: Agile consultants
* What: A one day training, acting as a coach

[P19]
* When: In the beginning
* Who: Ken Schwaber
* What: Train 60 Scrum masters

[P20, P21]
* When: In the beginning
* Who: Expert agile consultant
* What: Assessment of the current process, educating management and agile task force
* What: Recommended to adopt Scrum
* What: Supervised the agile course held to initial team members

[P23]
* When: In the transformation, when looking for more coaches
* Who: Exoftware Ltd
* What: A partnership to promoting and coaching agile delivery

[P25]
* When: During the first year
* Who: External consultants
* What: Participate in the transformation team, support transformation of teams
--
* When: Later
* Who: Acclaimed agile professionals, external speakers
* What: Give presentations, lead workshops

[P27]
* When: In the beginning
* Who: Renowed industry experts, ThoughtWorks
* What: Educate employees on agile practices
--
* When: In the first couple of months
* What: Coaching the team
* Particular: The teams were sceptical of having external consultants embedded
--
* When: In the middle of the transformation
* Who: Agile consultants who were familiar with all phases of the transformation
* What: Workshops, coaching
* What: Enabled forward progress, avoided time wasted in searching solutions

[P29]
* When: Introducing Scrum to the department, later internal people took over
* What: coaching teams
* Particular: Good having an impartial third party to fall back on

[P30]
* When: In beginning, and through out
* Who: Jeff Sutherland
* What: Scrum training for most of the engineering group
* What: Sell the agile approach in the beginning
* Benefit: An outside expert sells the agile approach in the beginning
* It worked out with the external expert where there had been failures earlier

[P31]
* When: Teams had implemented agile, it was time to renew the requirements management
* Who: Enthiosys, management consulting company, with deep agile experience
* What: Help in creating a system to deliver end to end in an agile way

[P34]
* When: In the beginning
* Who: ThoughtWorks consulting company
* What: Support project management and development
* Why: Accelerate use of agile practices

[P35]
* Who: Agile contractors
* Why: To speed up the development

[P37, P38]
* When: In the beginning
* Who: A local consulting firm
* What: Assist with the transformation
[P38]
* Why: To give a shining example of agile
* What: Mentoring and helping teams

[P39]
* When: In the beginning
* Who: Two consulting companies
* What: Coach implementing agile

[P40]
* When: In the beginning, they moved out after three months
* Who: Consultants
* Why: The key projects were not to be affected, so people with previous
       knowledge were needed to create a roadmap
* Benefit: They moved quickly, as they had previous experience of similar transformations

[P41]
* When: In the beginning
* Who: known agile coaches
* What: Create a vision
* What: Help in developing and leading a transition workshop

[P43]
* When: In the beginning
* Who: Consultant firms
* What: Give initial insights, give insights during the transformation

[P44]
* When: In the beginning
* Who: Ken Schwaber
* What: Assess the current state
* What: Hold workshops, certify Scrum masters
* Benefit: Get impartial feedback from an outside source

[P46]
* When: In the beginning
* Who: Ken Schwaber
* What: Organizational coach
* Coach pilot teams in the beginning

[P47]
* When: in the beginning
* Who: External consultants
* What: Coach the apprentice coaches
* Particular: The need for the external coaches reduced over time, and gave way for internal
* Benefit: Support the early growth of apprentice coaches

[P50]
* Who: Consultants from Scrum foundation
* What: Coaching, training

[P51]
* When: In the beginning
* Who: External consultant
* What: Assess the current state, and recommend what to do
* What: Provide training
...
\begin{table}[h]
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.51\textwidth}
        ...
        Coaching is essential in transformation  &
                P3, P6, P8, P9 P16, P17, P18, P29, P30, P33, P42, P44, P47, P48  \\
        \bottomrule
    \end{tabular}
...
* It is difficult to distinguish between team and organization. In most cases
  when talking about teams it refers to a handfull of people familiar to each
