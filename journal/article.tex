...
be included as long as it had some content matcing all the facets.
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.20\textwidth}
        ...
        Large scale    &
                At least 50 development personel or 6 teams uses agile &
...
search. We started by examining top ranked hits by trivial keywords that the
...
and ``large scale agile''. Secondly, a trial keyword search was done in the
...
increasing the manual filtering effort in the subsequent steps. Also the facet
or \emph{empiricality} could not be represented by keywords. Having a
substantial part of the matches in non-relevant areas such as agile
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.22\textwidth}
        ...
        Organizational transformation &
            ...
            "roll-out", rollout}\\
        Only software related atricles &
