...
feasible the agile method was tailored to suite the needs of the organization.
...
* Coordination challenge --> Team goal or product goal?
* Team centric focus created strong boundaries --> Bad for coordination
[P7]
A challenge we faced in team coordination was understanding whether to optimize
the team goal or the product goal. Some teams focused too much on their own
goals and created strong boundaries, impeding coordination.
...
* Well into the transformation there was trouble with dependencies between teams
...
possible – were  responsible to deliver  value regardless of location,
technology or historical allegiance.
However, within six months or so, and despite a pattern  of  success and
improvement, it became very clear that the new forking between horizontal
and vertical  teams  placed an enormous burden on the product and program
management teams to manage dependencies in a way that supported  the  broader
organizational roadmap.  Teams were structured to execute independently,  but
the broader product roadmap called for features that  implied  specific platform
improvements. Establishing a  reliable roadmap therefore required massive (and 
often unreliable) coordination between teams that were more often  than not
head-down in their own (sub-sprint) priorities.
Theoretically,  the product owners (assisted by the Music PMO) would ensure that
capabilities required by the  roadmap would appear on their own team’s backlog
at an appropriate level of priority.  In practice, it was very difficult to
identify  and track such dependencies, especially when the  feature  set  (and
associated set of dependencies) was constantly in flux.
...
* Team centricity --> Power --> However, they operate with independent priorities --> No respect for larger context (release)
...
* Scrum on team level --> Software interfaces not properly synchronized
* Problems with larger features
* Scrum on team level good --> True benefit requires entire program to be flexible for changes
[P26]
...
* Different customers compete --> Customer centricity does not view the system as a whole
[P29]
each customer base views the system only via their process flow.
We have multiple competing customers crossing multiple co-dependent
applications, including dependencies on applications outside of our
organization; multiple funding sources; and a mixture of Waterfall and Scrum
projects.
For our software teams to be able to execute efficiently, we will need to push
the complexity and prioritization upstream, scaling teams to meet demand while
maintaining clean, simple prioritized Product Backlogs for each product.
...
[P43] Ryan 2008 - The Price of Agile Is Eternal Vigilance.pdf - 43:11 [We implemented a scrum-of-scru..]  (4:48-4:200)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] [P: Scrum of scrums - Family: Practices] 
No memos

We 
implemented a scrum-of-scrums run by our release 
management team to identify inter-team dependencies 
and resolve merge issues before they occur.


[P45] Schnitter 2011 - Large-Scale Agile Software Development At Sap Ag.pdf - 45:18 [What could not be mitigated we..]  (4:2133-4:2292)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] 
No memos

What could not be mitigated were issues with teams dependent on “unreliable”
Scrum teams, at least if the Scrum teams were isolated in a non-Scrum environment.


[P45] Schnitter 2011 - Large-Scale Agile Software Development At Sap Ag.pdf - 45:28 [Several approaches are known t..]  (8:522-8:1054)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] [P: Scrum of scrums - Family: Practices] 
No memos

Several approaches are known to co-ordinate the work of several Scrum teams working
on one product, e.. Scrum of Scrums [9] or MetaScrum [18]. The size and complexity
of SAP’s products makes it necessary to consider these techniques. To co-ordinate the
work of multiple Scrum teams and to communicate the requirements via team product
backlogs, various approaches were combined. Special product teams were formed for
this purpose. These teams can be regarded as both a permanent Scrum of Scrums and a
supervisory product owner.


[P45] Schnitter 2011 - Large-Scale Agile Software Development At Sap Ag.pdf - 45:32 [Product teams were introduced ..]  (8:1076-8:1627)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] 
No memos

Product teams were introduced as a second organizational layer above the Scrum teams.
A product team is responsible for the work of up to 7 development teams. It consists
of the product owners of those teams and the same number of team members who
are specialists in particular ﬁelds. Depending on the problem area other experts may
be included. This allows for full engineering coverage of all problem areas expected,
well-organized communication among the teams, and direct communication with the
development teams to detect and mitigate risks.


[P45] Schnitter 2011 - Large-Scale Agile Software Development At Sap Ag.pdf - 45:33 [Product teams can rarely suppo..]  (9:841-9:1526)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] 
No memos

Product teams can rarely support more than seven Scrum teams. Ifthe products or components are be too big or too complex to be developed in this organizational setup, an
intermediate organizational layer is inserted between the product team and the Scrum
teams. These teams are called “area product teams”. Their responsibility is the same as
the product teams’ responsibility with the exception of budget and ﬁnal product decisions. In this three-layer organization a productteam works similar to a project management ofﬁce. The complete budget and product responsibility is with the product team,
while the operational day-to-day decisions are handled by the area product teams.


[P45] Schnitter 2011 - Large-Scale Agile Software Development At Sap Ag.pdf - 45:38 [Scaling Scrum to a multi-team ..]  (10:1223-10:1784)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] [O: Large scale definition - Family: Contextual] 
No memos

Scaling Scrum to a multi-team development organization is not as easy. Scrum of
Scrums and backlog preparation for many teams can be combined by product teams
as outlined above. Looking at all known parameters of agile project management at
SAP we tend to say that not much more than 130 development employees may be
organizedin that fashion. This number sums up developers in 7 teams (max. 70 people),
the product team (max. 16), developmentinfrastructure responsibles (about 10), quality
assurance and testers (about 25), general management (about 10).


[P48] Smits 2011 - Agile Experience Report - Transition And Complexity At Cisco Voice Technology Group.pdf - 48:30 [Tracking progress of hundreds ..]  (4:1657-4:2111)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] 
No memos

Tracking progress of hundreds of teams working on 
pieces of major features proved to be a major 
problem. Tools that we were using did not have roll 
up capability without imposing strict rules on how 
data was entered, labeled and updated. We found out 
our tools were not really scalable for the size and 
complexity of the programs we were working on. 
This proved a serious handicap in providing 
executive summary information about progress.


[P50] Sutherland 2011 - Hitting The Wall - What To Do When High Performing Scrum Teams Overwhelm Operations And Infrastructure.pdf - 50:20 [A key impediment was the distr..]  (4:1737-4:2643)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] 
No memos
...
[P51] Vlaanderen 2012 - Growing Into Agility - Process Implementation Paths For Scrum.pdf - 51:12 [Initially, the sprints lasted ..]  (5:230-5:717)   (Super)
Codes:  [C: Coordinating/integrating work of many teams - Family: RQ3: Challenges] 
No memos

Initially, the sprints lasted two or three weeks, depending on
the team, causing a discrepancy between the sprint durations of some of the
teams. At the same time, interdependencies started to become more of an issue
as the amount of teams grew. This caused problems when, for instance, frontend teams needed functionality in the back-end that was not yet developed.
These problems, which consisted mainly of delays, were solved by ﬁxating sprint
duration at two weeks for all teams.
