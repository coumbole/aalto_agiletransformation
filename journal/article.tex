...
to include only the factets \emph{agile software deveolpment} and
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.51\textwidth}
        ...
        Need to accomodate change during projects  &
...
Yet another factor pushing for improvement was the need to accomodate change
...
A most typical known problem was overhead in process, which showed as bureucracy and
