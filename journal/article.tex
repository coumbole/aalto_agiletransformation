...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.31\textwidth}
        ...
        Coaching    &
                P1, P2, P3, P6, P8, P9, P16, P18, P23, P27, P29,
                P33, P36, P39, P40, P41, P45, P46, P47, P50, P52  \\  % 21
        \bottomrule
    \end{tabular}
...
on human interactions, it is best learned in practice while a coach is giving
advice.



Coaches were driving the agile push [P2, P36], and advocating agile methods [P45].

Coaching was considered very important at project start [P8, P33, P46]. Otherwise
there may be severe long term consequences [P8].

Coaching was also seen as an important success factor [P29, P33].
The coach ensured that transformation would be successful [P16].

Having a impartial third party to rely on was a key success factor [P29].

Having too little coaches [23].

The agile adoption required coaches, especially at the start of agile projects
[P8, P46, P47].

Internal coaches were required for making the change grow [P47].

To be able to coach efficiently it was required that the coach had detailed
understanding of the company's processes and systems [P23]
