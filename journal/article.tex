...
Ongoing projects were set up with previous development methods, and the agile
methods had to be arranged to fit with them [P8, P29].

Using the old and new models side by side was seen as problematic [P26], and
causing tensions on all organizational levels [P10].

As Scrum teams did not commit to fixed schedules teams working according to the
original model labeled them unreliable [P45].

The agile teams were required to comply with current procedures producing excess
documentation and stepping through approval gates [P20, P21]. The bureucracy of
the previous traditional model was still enforced, and management was not
convinced to lighten the process. In one case it was described that after
introducing the agile method teams were required to fill in templates of two
processes [P48].

Despite the agile introduction development was attempted to be managed in the
old waterfall fashion. O'Connor [P38] described management as ``focused on
meetings and big up front project plans''. In another case management was losing
confidence in agile because familiar reports on cost analysis and percentage
complete were not produced [P35].
