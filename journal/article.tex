...
enabling agile software development. Typical investments were new management
tools, improvements in testing environments, and updating of the physical
working spaces. Table \ref{table:transformation_investments} summarizes common
...
\begin{table}[h]
    ...
    \begin{tabular}{ l l }
        ...
        Physical spaces can not be rearranged  &  P6, P29, P36, P38, P49  \\
        \bottomrule
    \end{tabular}
...
and effort, and it was not always possible [P6, P36, P38]. Lewis and Neher describe
