...
--> Experience reports have a subjective bias
...
* Transformation is continuous, hard work, and takes time
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.51\textwidth}
        ...
        Agile task group for coordinating change   &
                ...
                P43, P45, P48, P49, P50  \\
        Change leaders on other organizational levels  &
...
The tasks of the change team included first finding an alternative delivery
method to solve problems in the old model [P21, P30]. During the transformation
the team stimulated agile adoption in the organization [P18, P45, P49]. Examples
on their tasks were informing people on the agile model [P4], educating and
coaching [P16, P45, P48, P49], creating an agile cookbook [P23], and organizing
presentations and workshops [P25, P41]. The change team also assessed the
success of transformed teams, and worked for repeating their success across the
organization [P16, P40, P41]. Still one characteristic was that the team was
empowered to act on impediments they discovered [P16, P50].

% Other change leaders

Leadership for change emerged also on other organizational levels. In many cases
these change leaders were still in management positions [P14, P18, P17]. There
were also agile champions in teams who drove the change on a grassroots level
[P6, P9, P27].
...
heard of the new methodology [P6].
...
Even casual hallway talks could spread the word effectively, and it was
also easier to encounter people from other parts of the organization in an
informal context [P3].
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.31\textwidth}
        ...
        Internal personnel is coaching  &
                P2, P3, P6, P11, P16, P23, P29, P31, P32,
                P39, P41, P45, P47, P49, P50, P52  \\    % 16
        \bottomrule
    \end{tabular}
...
Who receives coaching --> Teams, very few cases with some other roles
...
% Coaching was a typical way for steering the agile adoption.
% What
...
[P6, P8, P33, P46, 47]. Brown [P8] stated that without adequate coaching there
would have been severe long term consequences [P8]. The application of coaching
was seen as an important success factor [P29, P33], and the job of the coach was
described to be to ensure that the transformation would be successful [P16].
One viewpoint was that the coach was an impartial third party who could be
relied on when resolving transformation impediments [P29].

% Having too little coaches [23].
...
described that the demand for coaching became permanent in order to keep the
development model healthy and to continuously pursue improvement [P6, P23].
Silva and Doss [P47] describe that internal coaches were required for making the
change grow. Over time the arrangement shifted from having external consultants
as coaches to creating an internal coaching community.

Some cases presented building of a coach community as an integral part of the
agile adoption [P6, P23, P32, P47].

To be able to coach efficiently it was required that the coach had detailed
understanding of the company's processes and systems [P23, P39].

The maturity of coaches grew over time [P32].
...
[P1, P2]
* Why: best for introducing agile methods
* Why: They drive the push
* How: Coach in the team

[P3]
* Why: The change leader persuaded to introduce coaching
* Coach: The change leader
* Who: teams
* How: Teams were coached

[P6]
* Why: It helps to have people with experience
* Coach: An internal change leader, a team of coaches
* Who: Teams
* How: Start heavy a kick-off, and later draw back
* Particular: There were little coaches at start
* Particular: The coaches showed positive results, and management was convinced to invest in coaching

[P8]
* Why: Intensive coaching is necessary 4-6 months at start

[P9]
* Coach: A hired consultant specialist
* How: The coach embodied the best agile principles

[P16]
* Why: To ensure transformation is successful
* Coach: The cross-functional rollout team

[P18]
* Coach: An agile consultant
* When: For over a year
* How: Accompanied the introduction for over a year, trained on specific agile practices

[P23]
* Coaches: In-house coaching team, some external coaches
* The coach community needed to be tended to specifically
* If there were too few coaches things did not work
* Pair coaching, apprentice coaching
* Particular: The coaches needed to have specific knowledge of the company's systems and processes
* Particular: Coaches in pairs --> training of coaches
* Particular: Focus on coaching

[P27]
* Coaches: External coaches
* How: Train on agile practices

[P29]
* Coaches: Agile consultants
* Why: Having a impartial third party was a key success factor
--
* Coaches: The pilot team, matured teams
* Who: Teams
* How: Helping other teams in getting started
* How: Taking a formal mentoring role when it is required

[P33]
* Who: Product owners
* Why: Crucial to make it successful
* Particular: Coaches were brought in after the start of the transformation, when trouble already existed

[P36]
* Coaches: Coaches from a subcontractor
* How: The coaches drive the project
* How: Mentor in-house leads to take lead as soon as possible
* How: Retrospect and adapt
* When: The need for coaches disappeared gradually
* The coach role was apparently seen as the lead of the project

[P39]
* Coach: External support, hired Chief Scrum masters
* How: inspect and adapt
* Particular: Internal coaches had better understanding of the company's procedures 

[P40]
* Who: Teams
* How: Coaching breakout sessions

[P41]
* Coach: Internal and external
* Who: Teams
* How: Coaching office hours
* How: Have a forum where teams can ask for help, and to share their implementation
* Particular: It was disliked to have peers as coaches, as they were not considered more knowledgeable

[P45]
* Coach: Internal small expert team
* Who: Teams
* How: Supporting, advocating agile development
* How: Educate and support teams interested in Scrum
* Particular: Later offering possibility to teach more Scrum mentors

[P46]
* The pilot teams were coached
* Who: Teams that are about to start agile projects
* How: A productized training workshop, and a jump start afterwards
* How: Key team roles are coached in the start, so that the start is successful

[P47]
* Why: The agile adoption required coaches
* Coaches: Initially external consultants
* Coaches: Internal people started taking coach positions
* Coaches: Apprentice coaches, guided by external experts
* Particular: A structure was created around coach certification
* Particular: A coach community

[P50]
* Coaches: Internal key roles, these received initial coach and role specific training
* When: When teams were starting
* How: Coached to facilitate start up of teams

[P52]
* Who: Paired line manager and Scrum master
* How: Pair coaching the pair itself
* Coach: In some cases an experienced Scrum master was brought to help the pair 
...
[P2]
* Why: There were too few coaches, so new ones were trained internally

[P3]
* Benefit: The internal coaches were accessible. You could easily acquire coaching for your team

[P6]
* What: There is a train the trainer program
* Why: Coaches can be expensive, more coaches can scale up agile more quickly

[P9]
* There was a lack of qualified coaches
* Why: hiring good external coaches was difficult
* It was hard to make the internal coaching resources work as well

[P11]
* Coaches: The Scrum masters served as internal coaches

[P16]
* Coaches: The roll-out team coached

[P23]
* A coach community evolved
* Why: The organization was so large
* How: Paired coaching

[P31]
* A certain person was hiread as senior agile coach, and he stayed through out the transformation
* Coach: A person was hired permanently

[P32]
* Particular: The maturity of coaches grew over time
* Why: There were so many people to educate

[P39]
* Benefit: Internal coaches had understanding of procedures and communication policies

[P45]
* What: After 8 months the coaches started training future Scrum mentors

[P47]
* Why: There was an internal need. It just was necessary to have coaches.
* How: First there were some external coaches, then an internal community was built
* Coaches: People who were passionate to teach agile

[P49]
* Why: To scale up agile implementation
* Why: The internal coaches create the change
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.31\textwidth}
        ...
        Pilot programs and other piloting   & 
                ...
                P36, P38, P40, P41, P43, P45, P46, P47  \\  % 22
        \bottomrule
    \end{tabular}
...
What amount of piloting is applied?
...
investments in themselves, the transformation process included specific
investments in some tangible entities. These investments were focused on better
enabling agile software development, and highlight the concerns that
organizations had when implementing an agile model. Typical investments were new
management tools, improvements in testing environments, and updating of the
...
\begin{table}
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.42\textwidth}
        ...
        \bottomrule
    \end{tabular}
    \caption{Summary of investments aiming to make agile methods perform better}
...
When a general problem of frequent broken builds existed it was easy to acquire a
buy in for creating an organization-wide standard for automating builds and
tests [P11]. On the other hand, many cases emphasized that building the
continuous integration environment required a significant investment [P17, P34,
P42]. In order to have the focus and resources for creating a proper integration
environment a dedicated team was Some organizations appointed a dedicated team
to ensure the focus and resources for creating a proper integration environment
were available [P5, P16, P17].
...
also how the practices were chosen affected.
...
why the change is being done and feel motivated [P1, P16, P42].
...
much on the implementation of practices [P23, P30].
...
communicated clearly. Articulating urgency at start will help getting the change
...
secondly, the urgency eliminated wasteful discussions on whether Scrum was a good
model or not [P11].
...
roll-out process to uniformly introduce a large number of teams to agile [P8].
...
teams use a uniform process [P41]. This would have been sub-optimal, as it was
