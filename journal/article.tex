...
promary studies. The ongoing change should be communicated intensively to
...
\begin{table}[h]
    ...
    \begin{tabular}{ >{\raggedright\arraybackslash}p{0.51\textwidth}
        ...
        \bottomrule
    \end{tabular}
    \caption{Succes factors relating to communicating the change}
...
they execute their tasks. To make te agile model work well teams need to
...
A few succes factors which did not fit in the above categories stood out. These
success factors are creating a positive experience in the beginning, arranging
socaial events, emphasizing principles over mechanics, and the previous
