...
unique organizations were identified in the primary studies.
...
\begin{table}
    ...
    \label{table:agile_methods}
\end{table}

The agile methods reported being used in the transformed organizations are
summarized in table \ref{table:agile_methods}. The most prevalent method was
