...
The formation and influence of agile communities had a significant impact on
transformation.
...
* A success factor: Agile communities emerged
* Communities are commonly created in agile initiatives
[P3]

* There was an agile community which spawned eager followers
* The community shared experiences and advice
* The community emerged self-organized
[P12]

* Project managers were in a matrix structure
* The matrix enabled sharing of learnings and confirmation 
[P12]

* The organization is planning on establishing an agile CoP
[P30]

* The coaches built up an agile community
* There was online discussions, newsletters, and workshop events
[P41]

* The company has communities of practice, which are effective in raising awareness
  of engineering practices
[P42]

* The agile coach community is a driving force --> They achieved becomming a driving force
* The community created practices promoting the use of agile methods in the organization
[P47]

* A collective group is required to make chage in an organization
* Impediments may be too large for individuals to move
[P47]



S: Have an agile community
