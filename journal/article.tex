...
As the organization is changing it is necessary to train people so they get some
...
Management was also among the first ones to receive agile training. In some
cases management received more in-depth training than the rest of the
organization [P11].
