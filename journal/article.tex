...
A keyword search in online databases was chosen as the search strategy. The
...
flexibility when constructing the search strings.
...
keywords are listed in Table \ref{table:searchterms}. The search yielded 1874
unique matches.
