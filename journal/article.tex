...
the change is mandated by management, and bottom-up leadership where the chage
...
We do not quantitively measure cases on the transformation process dimensions,
...
The most extreme case of adoption was a bing bang transformation. To realize
such a large change it is necessary that the change was centrally coordinated.
For step wise transformations there were three variants depending on the amount
of involvement of management and development teams. In some cases teams palyed a
passive role, and in some cases management was described to be reluctant to
change. In many cases both management and devlopment dealed with the
transformation on their respective level of influence.
...
organizations strived to introduce a culture of continuous improvement, which
would make organizational adjustment a permanent state. In many cases the agile
transformation was not considered to have ended at any distinct point in time,
and the impression that it was still ongoing was given. Finally, transformation
was simply described as hard work that will inevitably take a long time.
...
projects, as the applicability had to be proven in a releant environment [P8,
P40].
...
omitted. A pilot project was avioded because having two models side by side was
deemed to create organizational dissonance. Instead a significant amout of
