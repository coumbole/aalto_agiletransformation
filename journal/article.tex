...
\subsubsection{Challenges relating to leading the change}
...
overly eager attitude, but when agile did not deliver improvements quickly the
...
\subsubsection{Challenges in managing the changing organization}
